!(function (e) {
  ...
  var t = function (t, n, i) {
    function o() {
      a.addEventListener && a.removeEventListener("load", o),
        (a.media = i || "all");
    }
    var r,
      s = e.document,
    ...
    return (
      a.addEventListener && a.addEventListener("load", o),
      (a.onloadcssdefined = d),
      d(o),
      a
    );
  };
      ...
      if (
        ...
        (t.poly = function () {
          for (
            ...
            var i = t[n];
            "preload" === i.rel &&
              "style" === i.getAttribute("as") &&
              (e.loadCSS(i.href, i), (i.rel = null));
          }
        }),
        !t.support())
      ) {
  ...
  (function (e, t) {
    ...
    var C = (function (e) {
      ...
      try {
        H.apply((L = I.call(x.childNodes)), x.childNodes),
        ...
        return (
          ...
          ce(function (r, s, a, l) {
            var c,
              ...
              v = n ? (o || (r ? e : h || i) ? [] : s) : g;
            if ((n && n(g, v, a, l), i))
              for (c = ke(v, f), i(c, [], a, l), d = c.length; d--; )
                (u = c[d]) && (v[f[d]] = !(g[f[d]] = u));
            if (r) {
              if (o || e) {
                if (o) {
      ...
      if (((n = n || L), "string" == typeof e)) {
        ...
        if (i[1]) {
          if (
            ...
            $.test(i[1]) && x.isPlainObject(t))
          )
            for (i in t) h(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
          return this;
        }
        return (
          (o = g.getElementById(i[2])) && ((this[0] = o), (this.length = 1)),
          this
        );
      }
      return e.nodeType
          ...
          var n = [
            ...
            o = {
              ...
              then: function (t, i, o) {
                      ...
                      c = function () {
                        ...
                        if (!(t < r)) {
                          ...
                          (c =
                            ...
                            h(c)
                              ? o
                                ? c.call(e, s(r, n, D, o), s(r, n, M, o))
                                : (r++,
                                  c.call(
                                    e,
                                    s(r, n, D, o),
                                    s(r, n, M, o),
                                    s(r, n, D, n.notifyWith)
                                  ))
                              : (i !== D && ((a = void 0), (l = [e])),
                                (o || n.resolveWith)(a, l));
                        }
                ...
                return x
                  .Deferred(function (e) {
                    n[0][3].add(s(0, e, h(o) ? o : D, e.notifyWith)),
      ...
      x.fn.extend({
        data: function (e, t) {
          ...
          if (void 0 === e) {
            if (
              this.length &&
              ((o = V.get(r)), 1 === r.nodeType && !G.get(r, "hasDataAttrs"))
            ) {
              for (n = s.length; n--; )
                s[n] &&
    ...
    function be(e, t, n, i, o) {
      ...
      for (u.textContent = "", f = 0; (r = p[f++]); )
        if (i && -1 < x.inArray(r, i)) o && o.push(r);
          ...
          ((c = oe(r)), (s = ge(u.appendChild(r), "script")), c && ve(s), n)
        )
      ...
      special: {
        ...
        click: {
          setup: function (e) {
            var t = this || e;
            return (
              pe.test(t.type) && t.click && A(t, "input") && Se(t, "click", xe),
              !1
            );
          },
          trigger: function (e) {
    ...
    function He(e, t, n, i) {
      ...
      var o,
        ...
        g = t[0],
        v = h(g);
      if (v || (1 < p && "string" == typeof g && !f.checkClone && Ae.test(g)))
      ...
      if (
        ...
        for (l = (a = x.map(ge(o, "script"), Le)).length; u < p; u++)
          (c = o),
            u !== m &&
        ...
        if (l)
          for (
            d = a[a.length - 1].ownerDocument, x.map(a, Oe), u = 0;
            u < l;
            u++
          )
            (c = a[u]),
    ...
    x.extend({
      ...
      clone: function (e, t, n) {
        ...
        return (
          0 < (s = ge(d, "script")).length && ve(s, !u && ge(e, "script")), d
        );
      },
    ...
    function Je(e, t, n) {
      ...
      return (
        ((!f.boxSizingReliable() && o) ||
          ...
          (r = a in e) && (s = e[a])),
        (s = parseFloat(s) || 0) +
          Ve(e, t, n || (o ? "border" : "content"), r, i, s) +
          "px"
      );
    }
        ...
        _default: {
          ...
          set: function (e) {
            x.fx.step[e.prop]
              ? x.fx.step[e.prop](e)
              : 1 !== e.elem.nodeType ||
                (!x.cssHooks[e.prop] && null == e.elem.style[Be(e.prop)])
              ? (e.elem[e.prop] = e.now)
              ...
              u
                ? (f.ifModified &&
                  ...
                  204 === t || "HEAD" === f.type
                    ...
                    : 304 === t
                    ? (C = "notmodified")
                    : ((C = w.state), (p = w.data), (u = !(g = w.error))))
                : ((g = C), (!t && C) || ((C = "error"), t < 0 && (t = 0))),
              (T.status = t),
              (T.statusText = (n || C) + ""),
              u ? v.resolveWith(h, [p, C, T]) : v.rejectWith(h, [T, C, g]),
              T.statusCode(b),
              (b = void 0),
              d &&
                m.trigger(u ? "ajaxSuccess" : "ajaxError", [T, f, u ? p : g]),
              y.fireWith(h, [T, C]),
              d &&
    ...
    return (
      (x.noConflict = function (t) {
        return (
          e.$ === x && (e.$ = Yt), t && e.jQuery === x && (e.jQuery = Xt), x
        );
      }),
  ...
  (function (e) {
    ...
    function o(n) {
      ...
      (e.migrateDeduplicateWarnings && i[n]) ||
        ...
        o &&
          o.warn &&
          !e.migrateMute &&
          (o.warn("JQMIGRATE: " + n), e.migrateTrace && o.trace && o.trace()));
    }
    function r(e, t, n, i) {
    ...
    p))
      Object.prototype.hasOwnProperty.call(p, a) && (e.find[a] = p[a]);
    s(
      e.fn,
      "size",
      function () {
      ...
      return (
        e.each(t.match(y), function (t, i) {
          e.expr.match.bool.test(i) &&
            (o("jQuery.fn.removeAttr no longer sets boolean properties: " + i),
            n.prop(i, !1));
        }),
    ...
    e.swap &&
      ...
      (e.swap = function (e, t, n, i) {
        var r,
          s,
          a = {};
        for (s in (x || o("jQuery.swap() is undocumented and deprecated"), t))
      ...
      (e.fn.css = function (t, n) {
        ...
        return t && "object" == typeof t && !Array.isArray(t)
          ...
          : ("number" == typeof n &&
              ((r = i = b(t)),
              (k.test(r) && C.test(r[0].toUpperCase() + r.slice(1))) ||
                e.cssNumber[i] ||
                o(
    ...
    (e.data = function (t, n, i) {
      ...
      if (n && "object" == typeof n && 2 === arguments.length) {
        for (a in ((r = e.hasData(t) && $.call(this, t)), (s = {}), n))
          a !== b(a)
            ? (o("jQuery.data() always sets/gets camelCased names: " + a),
              (r[a] = n[a]))
            : (s[a] = n[a]);
      ...
      return n &&
        "string" == typeof n &&
        n !== b(n) &&
        (r = e.hasData(t) && $.call(this, t)) &&
        n in r
        ? (o("jQuery.data() always sets/gets camelCased names: " + n),
          2 < arguments.length && (r[n] = i),
          r[n])
    ...
    (e.event.props = []),
      ...
      (e.event.fix = function (t) {
        ...
        if (s.length)
          for (
            o("jQuery.event.props are deprecated and removed: " + s.join());
            s.length;
      ...
      (e.event.add = function (e, n) {
        return (
          e === t &&
            ...
            o("jQuery(window).on('load'...) called after load event occurred"),
          ...
          e.exports = function (e) {
            ...
            function l(t) {
              ...
              return (
                t &&
                  (o =
                    (o = o + s + e.collapsibleClass) + s + e.isCollapsedClass),
            ...
            function u(t) {
              return t &&
                ...
                ? (d(t, t.className.replace(s + e.isCollapsedClass, "")),
              ...
              updateToc: function (a) {
                      ...
                      "auto" === e.fixedSidebarOffset &&
                        ...
                        n > e.fixedSidebarOffset
                          ? -1 === i.className.indexOf(e.positionFixedClass) &&
                            (i.className += s + e.positionFixedClass)
                          : (i.className = i.className.replace(
                              s + e.positionFixedClass,
                              ""
                            ));
                    })();
                var p,
                ...
                if (r && null !== t && f.length > 0) {
                  i.call(f, function (t, n) {
                    return c(t) > l + e.headingsOffset + 10
                      ? ((p = f[0 === n ? n : n - 1]), !0)
                      : n === f.length - 1
                      ? ((p = f[f.length - 1]), !0)
                      : void 0;
                  ...
                  n.call(v, function (t) {
                    ...
                    m &&
                      -1 === m.className.indexOf(e.activeLinkClass) &&
                      (m.className += s + e.activeLinkClass);
                  var y = m && m.parentNode;
                  y &&
                    -1 === y.className.indexOf(e.activeListItemClass) &&
                    (y.className += s + e.activeListItemClass);
                  var b = t.querySelectorAll(
                    "." + e.listClass + "." + e.collapsibleClass
                  );
                  n.call(b, function (t) {
                    -1 === t.className.indexOf(e.isCollapsedClass) &&
                      (t.className += s + e.isCollapsedClass);
                  }),
                    m &&
                      m.nextSibling &&
                      -1 !==
                        m.nextSibling.className.indexOf(e.isCollapsedClass) &&
                      d(
                        m.nextSibling,
                        m.nextSibling.className.replace(
                          s + e.isCollapsedClass,
                          ""
                        )
                      ),
                    u(m && m.parentNode.parentNode);
                }
              },
            };
          };
                        ...
                        if (u) {
                          (s = (function () {
                            ...
                            s.scrollSmooth &&
                              ...
                              (a.scrollSmooth = n(374).initSmoothScrolling(s))),
                            (t = l(s)),
                            (i = c(s)),
                            (this._buildHtml = t),
                          ...
                          if (null !== m) {
                            ...
                            if (
                              null !== g &&
                              null !==
                                (o = i.selectHeadings(m, s.headingSelector))
                            ) {
            ...
            return {
                        ...
                        (function (t, i) {
                          for (
                            var r = o(t),
                              ...
                              a = i,
                              l = n(a),
                              c = s - (l ? l.headingLevel : 0);
                            c > 0 && (!(l = n(a)) || s !== l.headingLevel);

                          )
                            l && void 0 !== l.children && (a = l.children), c--;
              ...
              selectHeadings: function (t, n) {
                ...
                try {
                  ...
                  return (
                    console.warn("Headers not found with selector: " + i), null
                  );
                }
              },
            };
            ...
            if (t && t.scrollHeight > t.clientHeight) {
              ...
              if (n) {
                ...
                r < i + e.tocScrollOffset
                  ...
                  : s > o - e.tocScrollOffset - 30 &&
                    (t.scrollTop += s - o + e.tocScrollOffset + 60);
              }
            }
          };
        },
        ...
        getInline: function (n, i) {
          if ((L(), n.src)) {
            ...
            if (r.length) {
              ...
              s &&
                s.tagName &&
                (A || ((E = o.hiddenClass), (A = k(E)), (E = "mfp-" + E)),
                ($ = r.after(A).detach().removeClass(E))),
                  ...
                  w
                    .on("touchmove" + i, function (e) {
                      (d = e.originalEvent
                        ...
                        (u = d.length),
                        (d = d[0]),
                        (Math.abs(d.clientX - a) > 10 ||
                          Math.abs(d.clientY - l) > 10) &&
                          ((c = !0), n());
                    })
  ...
  (function (e, t) {
    ...
    function l() {
      !i &&
        ...
        (n.src = "//" + o + ".disqus.com/embed.js"),
        n.setAttribute("data-timestamp", +new Date()),
        (r.innerHTML = "Loading comments..."),
  ...
  (function (e) {
    e(window).on("load", function () {
          ...
          t.forEach(function (t) {
            t.isIntersecting
              ? (o.classList.remove("visible"),
                i.toggleAttribute("data-stuck", !1))
              : (o.classList.add("visible"),
                e("#header").hasClass("enable-sticky") &&
                  i.toggleAttribute("data-stuck", !0));
          });
        },
      ...
      e(document).ready(function (e) {
        e("[data-aos]").addClass("aos-animate"),
          tocbot.init({
        ...
        t.on("click", function () {
          ...
          e(".plan-price").length > 0 &&
            e(".plan-price").each(function () {
              var t = e(this).data("value") / 100;
              e(this).html(t);
            });
        var n = '<span title="%title%" class="mfp-close">&times;</span>',
          i =
            '<span class="mfp-arrow mfp-arrow-%dir%"><svg class="icon ularge"><use xlink:href="' +
            site_url +
            '/assets/images/svg-icons.svg#%dir%-arrow"></use></svg></span>';
        document
          .querySelectorAll(".kg-gallery-image img")
          .forEach(function (e) {
            ...
            e(this)
              ...
              .wrap(function () {
                return (
                  '<a href="' +
                  e(this).attr("src") +
                  '" class="hover-effect" rel="gallery"></a>'
                );
              }),
          ...
          e("#header div.menu-mobile, #header .open-menu").on(
            "click",
            function () {
          ...
          e(".epcl-post-carousel .slick-slider").each(function (t, n) {
            var i = parseInt(e(this).data("show")),
              o = !1;
            parseInt(e(this).data("rtl")) > 0 && (o = !0),
              e(this).slick({
                cssEase: "ease",
                fade: !1,
                arrows: !1,
          ...
          e(".epcl-demo-tool a").on("click", function (t) {
            ...
            e("body").toggleClass(n),
              e(this).toggleClass("active"),
              e("body").hasClass("disable-custom-colors")
                ? e(".epcl-category-overlay").hide()
                : e(".epcl-category-overlay").show(),
              e("body").hasClass("disable-decorations")
                ? e(".epcl-waves-page").hide()
                : e(".epcl-waves-page").show(),
              t.preventDefault();
          }),
