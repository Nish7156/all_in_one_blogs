...
function page() {
  return (
    <div>
        <>
  <main id="single" className="main grid-container classic epcl-vertical">
    {/* start: .center */}
        ...
        <div className="widget widget_epcl_article_info grid-25 tablet-grid-50 mobile-grid-100">
          ...
          <div className="info meta bg-box">
            <div className="item meta-info">
              ...
              <a href="/zento-personal/tag/lifestyle/" className="tag-name">
                Lifestyle
              </a>
            </div>
          ...
          <div className="toc">
            <ol className="toc-list ">
              ...
              <li className="toc-list-item">
                <a href="#ghost-members" className="toc-link node-name--H3 ">
                  Ghost Members
                </a>
              </li>
              <li className="toc-list-item">
